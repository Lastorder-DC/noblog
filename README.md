...
A static blog build on top of Notion and Nextjs, deployed on [Vercel](https://vercel.com?utm_source=Lastorder-DC&utm_campaign=oss).

NoBlog is fork of [nobelium](https://github.com/craigary/nobelium) by [@craigary](https://github.com/craigary)

<p>
  <a aria-label="GitHub commit activity" href="https://github.com/Lastorder-DC/noblog/commits/main" title="GitHub commit activity">
    <img src="https://img.shields.io/github/commit-activity/m/Lastorder-DC/noblog?style=for-the-badge">
  </a>
  <a aria-label="GitHub contributors" href="https://github.com/Lastorder-DC/noblog/graphs/contributors" title="GitHub contributors">
    <img src="https://img.shields.io/github/contributors/Lastorder-DC/noblog?color=orange&style=for-the-badge">
  </a>
  <a aria-label="Build status" href="#" title="Build status">
    <img src="https://img.shields.io/github/deployments/Lastorder-DC/noblog/Preview?logo=Vercel&style=for-the-badge">
  </a>
  <a aria-label="Powered by Vercel" href="https://vercel.com?utm_source=Lastorder-DC&utm_campaign=oss" title="Powered by Vercel">
...
- [Create new repo](https://github.com/Lastorder-DC/noblog/generate) from this template
...
<details><summary>Wait for a sec, what is Page ID?</summary>
  <img src="https://github.com/Lastorder-DC/noblog/blob/main/pageid.png?raw=true">
</details>

## Play With Docker

Not supported yet, come back later!
